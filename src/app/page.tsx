...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 via-gray-100 to-white">
      <NavBar />
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8 text-gray-800">
