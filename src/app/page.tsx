    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8 text-gray-100">
        <header className="text-center mb-16">
          <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-red-500 via-blue-500 to-yellow-500 text-transparent bg-clip-text animate-gradient">
            Welcome to Zeno
          </h1>
        ...
        <section className="mb-12 p-6 bg-gray-800/50 rounded-lg backdrop-blur-sm">
          <h2 className="text-3xl font-bold mb-4 text-red-400">Meet Zeno</h2>
          <p className="mb-6 text-gray-300">
            Zeno is the first{" "}
            <strong className="text-blue-400">100% free AI tutor</strong>{" "}
            designed to collaborate with teachers, helping every student succeed
          ...
          <ul className="space-y-4 text-gray-300">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                Zeno doesn&apos;t do homework for students. Instead, it coaches
                them, building critical thinking and problem-solving skills.
              </div>
            </li>
          </ul>
        </section>
        ...
        <section className="mb-12 p-6 bg-gray-800/50 rounded-lg backdrop-blur-sm">
          ...
          <ol className="space-y-4 text-gray-300 list-decimal list-inside">
            <li className="flex items-start">
              <div className="ml-2">
                <strong className="text-blue-400">Engage in Real-Time:</strong>{" "}
            ...
            <li className="flex items-start">
              <div className="ml-2">
                ...
                Automatically updates when teachers modify lesson plans, keeping
                everything relevant.
              </div>
            </li>
            <li className="flex items-start">
        ...
        <section className="mb-12 p-6 bg-gray-800/50 rounded-lg backdrop-blur-sm">
          ...
          <p className="text-gray-300">
            Best of all, Zeno is <strong className="text-blue-400">free</strong>{" "}
            and easy to use&mdash;no changes required to how teachers teach or
